...
public class TempIndexTest {
    ...
    @Test
    public void test() {
        System.out.println(printHexBinary("abc".getBytes()));
    }

    @Test
    public void test2() throws IOException {
        JitObject object = new JitObject("b.txt", Files.readAllBytes(Paths.get(TestUtil.resourcesPath() + "/data/index/b.txt")));
        System.out.println(Fingerprint.generate(object.encode()));
        System.out.println(printHexBinary("39a492da663687040f834a508a77fe2425942ed0".getBytes()));
    }
}
